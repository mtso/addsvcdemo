...
func MakeHTTPHandler(
	...
	m.Handle("/sum", transport.NewServer(
		...
		append(options, transport.ServerBefore(opentracing.FromHTTPRequest(trace, "Sum", logger)))...,
	))
	return m
}
...
func DecodeHTTPSumResponse(_ context.Context, f *http.Response) (interface{}, error) {
